...
Author: ibnuasad
Contributors: ibnuasad,thamizhchelvan
Donate link: http://www.themiak.com/donate.php
Tags: nofollow,link,links,sponsored,post,posts,google,formatting,html,custom,code,filter,seo,wordpress,xhtml,2.5,2.5.1,2.5.2,2.6,2.6.1,2.6.2,2.6.3,2.6.5,2.7,tag,tags
...
Nofollow Links in Posts plugin enables you to add the "nofollow" attribute into links in a post within a specified category. This plugin 
...
1. Go to the 'Settings' menu and click on 'Nofollow Links in Posts' to see the plugin options.
